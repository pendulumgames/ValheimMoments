...
**Windows x64 beta - version 0.15.0.** Manual capture, deaths, boss/loot clips,
...
See the [development plan](docs/DEVELOPMENT-PLAN.md) for upcoming raid/close-call clips, director refinements and the gallery. Those additions are not shipped in this milestone.
...
The second validates and creates `artifacts/Valheim_Moments-0.15.0.zip`, including

...
**Windows x64 beta — version 0.10.0.** Manual capture, deaths, boss summaries and loot
...
The second validates and creates `artifacts/Valheim_Moments-0.10.0.zip`, including

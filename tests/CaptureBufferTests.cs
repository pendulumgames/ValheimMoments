...
internal static class CaptureBufferTests
{
    ...
    public static void Main()
    {
        ...
        Check(limits.Width >= 480 && limits.Height >= 270 && limits.Height <= limits.Width * 2 && limits.FPS >= 1 && limits.FPS <= 30 && limits.Quality == 100, "Extreme capture values and tall aspect ratio bounded");
        ...
        Check(limits.Width == 480 && limits.Height == 270 && limits.FPS == 1 && limits.BudgetMiB == 48 && limits.PoolBytes <= 48 * 1048576L && limits.ClipBytes <= 256 * 1048576L, "Individually valid extremes fit combined memory limits");
        var bounded = new CaptureBuffer(limits.Width, limits.Height, limits.FPS, 30, 30, limits.BudgetMiB * 1048576L, 30);

...
namespace ValheimMoments
{
    internal static class GalleryInput
    {
        ...
        internal static void Install(Harmony harmony)
        {
            ...
            harmony.Patch(AccessTools.DeclaredMethod(typeof(PlayerController), "TakeInput"), postfix: new HarmonyMethod(typeof(GalleryInput), nameof(Input)));
            ...
            harmony.Patch(AccessTools.DeclaredMethod(typeof(ZInput), "GetMouseScrollWheel"), postfix: new HarmonyMethod(typeof(GalleryInput), nameof(Scroll)));
        }
        private static void Input(ref bool __result) { if (Open?.Invoke() == true) __result = false; }
        private static void Scroll(ref float __result) { if (Open?.Invoke() == true) __result = 0; }

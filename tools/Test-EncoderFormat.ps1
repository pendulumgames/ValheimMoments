...
$helper = Join-Path $workspace 'src/ValheimMoments.Encoder/bin/Release/net48'
...
& (Join-Path $test 'EncoderFormatTests.exe') (Join-Path $helper 'ValheimMoments.Encoder.exe') $test

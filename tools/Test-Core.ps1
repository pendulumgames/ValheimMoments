...
& $compiler /nologo /warnaserror+ /optimize+ /target:exe "/out:$exe" (Join-Path $workspace 'src/ValheimEventClips.Core/CaptureBuffer.cs') (Join-Path $workspace 'tests/CaptureBufferTests.cs')
